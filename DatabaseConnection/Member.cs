    ...
    public partial class Member : Form
    {
        ...
        private void btnAdd_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                {
                    MemberInfo.registerMembers(txtMemberName.Text, txtMemberAddress.Text, txtBailedName.Text, txtBailedphone.Text, txtMemberPhone.Text);
                    MemberInfo.loadAllMembers(MemberView);
                    makeEmptyMember();
        ...
        private void btnUpdate_Click(object sender, EventArgs e)
        {
            ...
            {
                MemberInfo.updateMembers(txtMemberName.Text, txtMemberAddress.Text, txtBailedName.Text,txtBailedphone.Text, txtMemberPhone.Text,updateId);
                MemberInfo.loadAllMembers(MemberView);
                makeEmptyMember();
            }
        }
        ...
        private void MemberCellClick(object sender, DataGridViewCellEventArgs e)
        {
           ...
           // btnAdd.Enabled = false;
            ...
            txtBailedName.Text = (string)MemberView.SelectedRows[0].Cells[3].Value;
           txtBailedphone.Text = (string)MemberView.SelectedRows[0].Cells[4].Value;
            txtMemberPhone.Text = (string)MemberView.SelectedRows[0].Cells[5].Value;
        }
        ...
        public void serachText()
        {
            using (SqlConnection conn = myConnections.GetConnections())
            {
                ...
                SqlCommand cmd = new SqlCommand("SELECT id 'ID', name 'Name', address 'Address', bname 'B Name', bphone 'B Phone' ,phone 'Mem Phone', date 'Date' FROM member WHERE name LIKE '" + txtSearch.Text + "%'", conn);
