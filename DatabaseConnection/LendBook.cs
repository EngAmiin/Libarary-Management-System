    ...
    public partial class LendBook : Form
    {
        ...
        private void btnAdd_Click(object sender, EventArgs e)
        {
           ...
           (comBoxMemberId.Text.StartsWith("X")) || (comBoxMemberId.Text.StartsWith("Y")) ||
            ...
            else
            {
                ...
                LendBookInfo.registerLendBook(memberId,memberName,bookName,issueDate,returnDate);
        ...
        private void LendBookCellClick(object sender, DataGridViewCellEventArgs e)
        {
          ...
          //  btnAdd.Enabled = false;
            ...
            comBoxName.Text = (string)LendBookView.SelectedRows[0].Cells[3].Value;
        ...
        private void btnUpdate_Click(object sender, EventArgs e)
        {
           ...
           (comBoxMemberId.Text.StartsWith("X")) || (comBoxMemberId.Text.StartsWith("Y")) ||
            ...
            else
            {
                ...
                LendBookInfo.updateLendBook(memberId, memberName, bookName, issueDate, returnDate,updateId);
                LendBookInfo.loadAllLendBook(LendBookView);
                MakeEmptLendyBooks();
