...
namespace DatabaseConnection
{
    public class LendBookInfo
    {
        ...
        public static void registerLendBook(int mid, string mname, string bname, DateTime issuedate, DateTime rdate)
        {
            try
            {
                conn = myConnections.GetConnections();
        ...
        public static void updateLendBook(int mid,string mname, string bname, DateTime issuedate,  DateTime rdate,int updateid)
        {
            try
            {
                conn = myConnections.GetConnections();
