...
namespace DatabaseConnection
{
    public class MemberInfo
    {
        ...
        public static void registerMembers(string name, string address, string bname, string bphone, string mphone)
        {
            try
            {
                conn = myConnections.GetConnections();
        ...
        public static void updateMembers(string name, string address, string bname, string bphone, string mphone, int updateid)
        {
            try
            {
                conn = myConnections.GetConnections();
