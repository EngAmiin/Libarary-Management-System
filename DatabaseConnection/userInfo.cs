...
namespace DatabaseConnection
{
    public class userInfo
    {
        ...
        public void registerUsers(string name, string sex, string username, string passWord, string utype, string phone)
        {
            try
            {
                conn = myConnections.GetConnections();
        ...
        public void updateUsers(string name, string sex, string username, string passWord, string utype, string phone,int updateId)
        {
            try
            {
                conn = myConnections.GetConnections();
