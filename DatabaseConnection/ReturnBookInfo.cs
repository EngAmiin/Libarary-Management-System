...
namespace DatabaseConnection
{
    public class ReturnBookInfo
    {
        ...
        public static void registerReturnBook(int mid, string bname, string rdate , int elap, double fine)
        {
            try
            {
                conn = myConnections.GetConnections();
        ...
        public static void updateReturnBook(int mid, string bname, string rdate, int elap, double fine,int updateid)
        {
            try
            {
                conn = myConnections.GetConnections();
                ...
                MessageBox.Show("Successfully Updated Returned Book ✔", "Success", MessageBoxButtons.OK, MessageBoxIcon.Information);
                conn.Close();
            }
            catch
            {
